...
const loveReasons = [
  ...
  "Пожалуйста, не забывай вовремя кушать и тепло одеваться, мой самый дорогой человечек. 🧦🥧",
  "Ты моё вдохновение для создания этого сайта и вообще для всего на свете. 💻❤️",
  "Обожаю наши ночные разговоры, когда мы стираем границы времени и болтаем обо всём. 📞✨",
  ...
  "Ты котенок, которому официально разрешено воровать еду из моей тарелки. 🍕 пищи!",
